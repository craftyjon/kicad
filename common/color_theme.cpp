...
const COLOR_THEME COLOR_THEME_MANAGER::defaultTheme = {
    ...
    /// Netnames layers
    { LAYER_PAD_FR_NETNAMES,       COLOR4D( 1.0, 1.0, 1.0, 0.9 ) },
    { LAYER_PAD_BK_NETNAMES,       COLOR4D( 1.0, 1.0, 1.0, 0.9 ) },
    { LAYER_PADS_NETNAMES,         COLOR4D( 1.0, 1.0, 1.0, 0.9 ) },

    /// Pcbnew GAL Layers
    { LAYER_VIAS,                  COLOR4D( LIGHTGRAY ) },
    { LAYER_VIA_MICROVIA,          COLOR4D( 0.4, 0.4, 0.8, 0.8 ) },
    { LAYER_VIA_BBLIND,            COLOR4D( 0.6, 0.6, 0.6, 0.8 ) },
    { LAYER_VIA_THROUGH,           COLOR4D( 0.6, 0.6, 0.6, 0.8 ) },
    ...
    { LAYER_ANCHOR,                COLOR4D( 0.3, 0.3, 1.0, 0.9 ) },
    { LAYER_PAD_FR,                COLOR4D( RED ) },
    { LAYER_PAD_BK,                COLOR4D( GREEN ) },
    { LAYER_RATSNEST,              COLOR4D( 0.4, 0.4, 0.4, 0.8 ) },
    ...
    { LAYER_PADS,                  COLOR4D( 0.6, 0.6, 0.6, 0.8 ) },
    { LAYER_PADS_HOLES,            COLOR4D( 0.0, 0.5, 0.5, 0.8 ) },
    { LAYER_VIAS_HOLES,            COLOR4D( 0.5, 0.4, 0.0, 0.8 ) },
    { LAYER_DRC,                   COLOR4D( 1.0, 0.0, 0.0, 0.8 ) },
    { LAYER_WORKSHEET,             COLOR4D( 0.5, 0.0, 0.0, 0.8 ) },
